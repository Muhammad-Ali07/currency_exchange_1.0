<div id="inLineHelp" data-id="buy_cash_currency_help">
    <div class="inLineHelp inline_help_table">
        ...
        <div class="data_thead_row" id="buyCashCurrencyHelp">
        ...
        @foreach($data['chart'] as $chart)
            <div class="data_tbody_row">
                <table border="1" class="val_table" width="100%">
                    <tbody>
                    <tr class="data-dtl">
                        <td data-view="show" data-field="buy_cash_chart_code" width="50%">{{$chart->code}}</td>
                        <td data-field="buy_cash_chart_name" width="50%">{{$chart->name}}</td>
                    </tr>
                    <tr class="d-none">
                        <td data-field="buy_cash_chart_id">{{$chart->id}}</td>
                        <td data-field="product_id">{{$chart->product_id}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
