<div id="inLineHelp" data-id="transactionType">
    <div class="inLineHelp inline_help_table">
        ...
        <div class="data_thead_row" id="transactionTypeHelp">
            <table border="1" class="" width="100%">
                <thead>
                <tr>
                    <th data-field="Type" width="25%">Type</th>
                </tr>
                </thead>
            </table>
        </div>
        ...
        @foreach($data['transaction_types'] as $tt)
            <div class="data_tbody_row">
                <table border="1" class="val_table" width="100%">
                    <tbody>
                    <tr class="data-dtl">
                        <td data-field="transaction_type" width="25%">{{$tt}}</td>
