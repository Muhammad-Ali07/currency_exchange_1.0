<div id="inLineHelp" data-id="cash_currency_help">
    <div class="inLineHelp inline_help_table">
        ...
        <div class="data_thead_row" id="cashCurrencyHelp">
        ...
        @foreach($data['chart'] as $chart)
            <div class="data_tbody_row">
                <table border="1" class="val_table" width="100%">
                    <tbody>
                    <tr class="data-dtl">
                        <td data-view="show" data-field="cash_chart_code" width="50%">{{$chart->code}}</td>
                        <td data-field="cash_chart_name" width="50%">{{$chart->name}}</td>
                    </tr>
                    <tr class="d-none">
                        <td data-field="cash_chart_id">{{$chart->id}}</td>
                        <td data-field="cash_product_id">{{$chart->product_id}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
