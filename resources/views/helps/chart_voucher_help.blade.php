<div id="inLineHelp" data-id="chart_voucher_help">
    <div class="inLineHelp inline_help_table">
        ...
        <div class="data_thead_row" id="chartVoucherHelp">
        ...
        @foreach($data['chart'] as $chart)
            <div class="data_tbody_row">
                <table border="1" class="val_table" width="100%">
                    <tbody>
                    <tr class="data-dtl">
                        <td data-view="show" data-field="ledger_code" width="50%">{{$chart->code}}</td>
                        <td data-field="ledger_name" width="50%">{{$chart->name}}</td>
                    </tr>
                    <tr class="d-none">
                        <td data-field="ledger_id">{{$chart->id}}</td>
