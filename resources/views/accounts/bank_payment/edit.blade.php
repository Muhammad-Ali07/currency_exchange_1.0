                                        ...
                                        <div class="table-scroll form_input__block">
                                            <table class="egt_form_table table table-bordered">
                                                ...
                                                <tr class="egt_form_header_input">
                                                    ...
                                                    <td>
                                                        <input id="egt_amount" type="text" class="FloatValidate amount form-control form-control-sm">
                                                    </td>
                                                    <td>
                                                        <input id="egt_rate" type="text" class="FloatValidate rate_per_unit form-control form-control-sm">
                                                    </td>
                                                    <td>
