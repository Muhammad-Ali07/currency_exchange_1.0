...
@section('content')
    ...
    <section id="faq-search-filter">
        <form id="customer_ledger_report" target="_blank" class="customer_ledger_report faq-search-input" action="{{route('reports.customer.store')}}" method="post" autocomplete="off">
            @method('post')
            @csrf
