...
@section('content')
    ...
    <section id="faq-search-filter">
        <form id="currency_ledger_report" target="_blank" class="currency_ledger_report faq-search-input" action="{{route('reports.currency.currencyLedgerReport')}}" method="post" autocomplete="off">
            @method('post')
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="text-danger">Cash Currency Ledger Report</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                            {{-- <form id="currency_ledger_report" class="currency_ledger_report faq-search-input" action="{{route('reports.currency.currencyLedgerReport')}}" method="post" enctype="multipart/form-data" autocomplete="off"> --}}
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <label class="form-label" for="basic-default-password1"><b>Cash in Hand Chart Code</b></label>
                                                <div class="col-sm-12">
