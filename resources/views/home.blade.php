        ...
        <div class="row justify-content-center">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                @if ($i == '0')
                                                <img src="{{ asset('assets/images/misc/7047082.png') }}" class="me-75" height="20" width="20" alt="Angular" />
                                                @elseif($i == '1')
                                                <img src="{{ asset('assets/images/misc/download (2).jpeg') }}" class="me-75" height="20" width="20" alt="Angular" />
                                                @elseif($i == '2')
                                                <img src="{{ asset('assets/images/misc/1922568.png') }}" class="me-75" height="20" width="20" alt="Angular" />
                                                @elseif($i == '3')
                                                <img src="{{ asset('assets/images/misc/appartment.png') }}" class="me-75" height="20" width="20" alt="Angular" />
                                                @endif
                                                {{-- <span class="fw-bold">{{ $bt->name }}</span> --}}
                                                <span class="fw-bold">{{ $bt }}</span>
                                            </td>
                                            {{-- <td>
                                                @php
                                                    $products = App\Models\Product::where('buyable_type_id',$bt->id)->get();
                                                    $sold = '0';
                                                    $remaining = '0';
                                                    foreach ($products as $p) {
                                                        # code...
                                                        $sale = App\Models\Sale::where('product_id',$p->id)->count();
                                                        if($sale){
                                                            $sold++;
                                                        }else{
                                                            $remaining++;
                                            ...
                                            <td>
                                                <span class="text-primary">{{ $data['products_sold'][$i] }}</span> / <span class="text-warning">{{ $data['products_remaining'][$i] }}</span>
                                            </td>
                                        </tr>
                                        @php $i++; @endphp
                                        @endforeach
            ...
            <div class="col-lg-6 col-12 ">
                <div class="card card-revenue-budget">
                    <div class="col-12 revenue-report-wrapper">
                            <div id="table-without-card">
                            <h4 class="mb-1">Receiveable Amount</h4>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                @elseif($i == '3')
                                                <img src="{{ asset('assets/images/misc/appartment.png') }}" class="me-75" height="20" width="20" alt="Angular" />
                                                @endif{{-- <span class="fw-bold">{{ $bt->name }}</span> --}}
                                                <span class="fw-bold">{{ $bt }}</span>
                                            </td>
                                            {{-- <td>
                                                @php
                                                    ...
                                                    foreach ($products as $p) {
                                                        # code...
                                                        $sale = App\Models\Sale::where('product_id',$p->id)->where('is_installment','!=','0')->first();
                                                        if($sale){
